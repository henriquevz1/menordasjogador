...
export const Route = createFileRoute("/privacidade")({ head: () => ({ meta: [
  { title: "Política de Privacidade — MENOR JOGADOR" }, { name: "description", content: "Informações sobre privacidade e dados no site MENOR JOGADOR." }, { property: "og:title", content: "Política de Privacidade — MENOR JOGADOR" }, { property: "og:description", content: "Saiba como seus dados são tratados durante o atendimento e a compra." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary" },
...
function PrivacidadePage() { return <LegalPage eyebrow="Transparência" title="Política de privacidade" description="Conteúdo-base editável. A loja deve revisar e completar esta política conforme sua operação real.">
  ...
  <EditableBlock title="Compartilhamento e armazenamento"><p>Prestadores envolvidos, períodos de retenção e medidas adotadas: a definir pela MENOR JOGADOR.</p></EditableBlock>
