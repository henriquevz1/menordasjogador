...
export const Route = createFileRoute("/trocas")({ head: () => ({ meta: [
  { title: "Trocas e Devoluções — MENOR JOGADOR" }, { name: "description", content: "Consulte as condições de troca e devolução da MENOR JOGADOR." }, { property: "og:title", content: "Trocas e Devoluções — MENOR JOGADOR" }, { property: "og:description", content: "Prazos, condições e orientações para trocas na MENOR JOGADOR." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary" },
...
function TrocasPage() { return <LegalPage eyebrow="Atendimento" title="Trocas e devoluções" description="Esta página está preparada para receber a política real da loja. Confirme sempre as condições antes da compra.">
  <EditableBlock title="Prazo para solicitar troca"><p>A definir pela MENOR JOGADOR.</p></EditableBlock>
  ...
  <EditableBlock title="Quando a troca não é aceita"><p>Situações não aceitas: a definir pela MENOR JOGADOR antes da publicação definitiva.</p></EditableBlock>
</LegalPage> }